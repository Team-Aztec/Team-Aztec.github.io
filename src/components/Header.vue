  ...
  <header is="azt-header" id="header">
    <nav>
      <ul class="nav-list">
        ...
        <li>
          <router-link class="nav-link" :to="{ name: 'Competitions' }">
            Compétitions
          </router-link>
        </li>
        <li>
          <a class="nav-link nav-soon">
            <svg class="sparks" viewBox="0 0 142 64">
              ...
              <use
                xlink:href="#spark"
                style="--x: 60px; --y: 0px; --delay: -0ms"
              ></use>
              <use
                xlink:href="#spark"
                style="--x: 35px; --y: -30px; --delay: -400ms"
              ></use>
              <use
                xlink:href="#spark"
                style="--x: -16px; --y: -24px; --delay: -150ms"
              ></use>
              <use
                xlink:href="#spark"
                style="--x: 0px; --y: -6px; --delay: -800ms"
              ></use>
            </svg>
            Boutique
          </a>
